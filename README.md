...
Find the source code here: [webvist/XrayR](https://github.com/webvist/XrayR)
...
```
wget -N https://raw.githubusercontents.com/webvist/XrayR-script/master/install.sh && bash install.sh
```
...
2. `git clone https://github.com/webvist/XrayR-script XrayR-release`
3. `cd XrayR-release`
4. 编辑config。
...
[![Stargazers over time](https://starchart.cc/Misaka-blog/XrayR-script.svg)](https://starchart.cc/webvist/XrayR-script)
